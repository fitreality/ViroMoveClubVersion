...
USTRUCT(BlueprintType)
struct FTrainingModePlayerSettings
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		ETrainingGola trainingGoal;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float trainingGoalValue;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalDifficulty trainingIntervalDifficulty;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<EBackendLevelType> AvailibleLevelTypes;
};



USTRUCT(BlueprintType)
struct FMusicChangeMapC
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString Song;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float songStartTimeInSeconds;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float newSongSwitchTimeInCentimeters;


};

USTRUCT(BlueprintType)
struct FTrainingIntervalsChangeMapC
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString levelGuid;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalDifficulty trainingIntervalDifficulty;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalType trainingIntervalType;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float newIntervalSwitchTimeInCentimeters;
};

USTRUCT(BlueprintType)
struct FGeneratedTraining
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		ETrainingPhase TrainingPhase;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray< FMusicChangeMapC> musicChangeMaps;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<FTrainingIntervalsChangeMapC> intervalChangeMaps;
};

USTRUCT(BlueprintType)
struct FTrainingModuleAvailable
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool isTrainingModuleAvailable;
};

USTRUCT(BlueprintType)
struct FFitnessTrainingUnitAvailable
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool isFitnessTrainingUnitAvailable;
};

USTRUCT(BlueprintType)
struct FTrainingDurationParamsDetailed
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalType trainingIntervalType;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float trainingDurationInSeconds;
};

USTRUCT(BlueprintType)
struct FTrainingDurationParams
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<FTrainingDurationParamsDetailed>  trainingDurationParams;
};

USTRUCT(BlueprintType)
struct FtrainingGameResult
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float  kcalBurned;
...
USTRUCT(BlueprintType)
struct FTrainingStartGame
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString localStartDateTime;
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FTrainingModePlayerSettings trainingModeGamerSettings;
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<FGeneratedTraining>customTrainingScenarios;
};

USTRUCT(BlueprintType)
struct FEndCustomTrainingGame
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString gameGuid;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FtrainingGameResult trainingGameResult;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
...
USTRUCT(BlueprintType)
struct FCustomTrainingGameResult
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
...
USTRUCT(BlueprintType)
struct FTrainingModeGameSettings
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		float LengthInSec;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalType IntervalType;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalDifficulty IntervalDifficulty;
};
...
USTRUCT(BlueprintType)
struct FTrainingModeLevels
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<FTrainingModeLevel> Songs;
};
	...
	//-----------------Stations---------------------------------------------------------------------------------//
USTRUCT(BlueprintType)
struct FAuthenticationCodeStations
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
...
USTRUCT(BlueprintType)
struct FAuthenticationCodeStationsResponse
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString token;
...
struct FActiveSession
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FString accountGuid;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		FDateTime sessionEndDateTimeInUtc;
};
...
USTRUCT(BlueprintType)
struct FtrainingTypeAvailabilities
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		EtrainingIntervalType trainingIntervalType;
...
struct FBackendlevelAvailability
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool availableInBattles;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool availableInCompetitions;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool availableInTraining;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray< FtrainingTypeAvailabilities> trainingTypeAvailabilities;
};
...
USTRUCT(BlueprintType)
struct FGetLevelsByAvailabilityDetailed
{
	GENERATED_BODY()
		UPROPERTY(EditAnywhere, BlueprintReadWrite)
		bool isDeleted;
...
USTRUCT(BlueprintType)
struct FGetLevelsByAvailability
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		int maxTimestamp;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
		TArray<FGetLevelsByAvailabilityDetailed> levels;
};
